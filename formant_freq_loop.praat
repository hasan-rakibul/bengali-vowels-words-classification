...
use_sound$ = "Word'foldername'_'fln'" 		
#each file name in the subfolder

Read from file... /media/rakibul/WorkFolder/Work/Thesis/Speech_Recognition/Bangla_Word/WData_all/Word/Word'foldername'/'use_sound$'.wav
...
for i from 5 to 'tot_sample'
     ...
     fileappend  /media/rakibul/WorkFolder/Work/Thesis/Speech_Recognition/Bangla_Word/WData_all/Formant/Formant'foldername'/'use_sound$'_Formant_frq.txt 'vtime:3'       'f1:2'          'f2:2'        'f3:2'         'f4:2'         'f5:2'  'newline$'    
